...
Repositori ini masih berada pada fase **dokumentasi dan validasi kebutuhan**. Belum
ada backend bisnis yang diimplementasikan. Pengembangan implementasi hanya boleh
dimulai setelah dokumen dasar disetujui sesuai *documentation gate* di
